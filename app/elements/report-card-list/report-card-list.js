	...
	_onEntryStart() {
		...
		this.async(() => {
			...
			this.cards = [
				...
				{ name: 'Random report', 'mainFigureValue': 12, 'mainFigureAbbr': 'L', 'mainFigureDesc': 'This Week', 'mainFigureComparisonValue': 30, keyItems: keyItems2 },
				{ name: 'Report ABC', 'mainFigureValue': 3, 'mainFigureAbbr': 'K', 'mainFigureDesc': 'This Week', 'mainFigureComparisonValue': 40, keyItems: keyItems3 },
